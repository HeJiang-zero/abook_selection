...
async function renderChart() {
  ...
  instance.setOption({ backgroundColor: 'transparent', tooltip: { trigger: 'axis' }, legend: { textStyle: { color: '#9fb3c9' } }, grid: { left: 58, right: 18, top: 42, bottom: 42 }, xAxis: { type: 'category', data: x, axisLabel: { color: '#8497ad' } }, yAxis: { type: 'value', name: props.activeTab === 'risk' ? '用户数' : '', axisLabel: { color: '#8497ad' }, nameTextStyle: { color: '#8497ad' }, splitLine: { lineStyle: { color: '#20364e' } } }, series })
}
